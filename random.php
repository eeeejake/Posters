...
if (!isset($_SESSION['authenticated'])) {
    echo '<script type="text/javascript">alert("You must login to access this page!")</script>';
    //echo $users;
...
<head>
<title>Random Filter for an Uploaded Image</title>
<!-- PHP Scripts here -->
...
<br />       
    ...
    <h3>Randomizer</h3>
        <p>This PHP&nbsp;GD image effect will perform a random image filter on a version of a .jpg image and save a copy, along with a thumbnail, to a specified directory. </p>
