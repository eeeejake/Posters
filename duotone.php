...
<head>
<title>Duotone an Uploaded Image</title>
<!-- PHP Scripts here -->
...
<br />       
    ...
    <h3>Duotoner</h3>
        <p>This PHP&nbsp;GD image effect will create a "duotone" version of a .jpg image and save a copy, along with a thumbnail, to a specified directory. This duotone is created from random RGB numbers which generate a different color value each time an image is processed.</p>
